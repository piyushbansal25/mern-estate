...
import { FaBath, FaBed, FaChair, FaMapMarked, FaMapMarkerAlt, FaParking, FaShare } from 'react-icons/fa';
  ...
  const params = useParams();
    ...
    return <main>
        ...
        <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
            ...
            <ul className='text-green-900 font-semibold text-s flex flex-wrap  items-center gap-4 sm:gap-6'>
                <li className='flex items-center gap-1 whitespace-nowrap m '>
