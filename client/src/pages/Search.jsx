  ...
  return (
    <div className='flex flex-col md:flex-row'>
      ...
      <div className='flex-1'>
        <h1 className='text-3xl font-semibold border-b p-3 text-slate-700 mt-5 ml-2'>Listing Results:</h1>
        <div className='p-3 flex flex-wrap gap-4'>
          {!loading && listings.length === 0 && (
            <p className='text-xl text-red-700'>No listings found!!!</p>
          )}
          {loading && (
      ...
      <button className=' text-green-700 p-3  hover:scale-105 tranistion-scale duration-300 underline w-full' onClick={
